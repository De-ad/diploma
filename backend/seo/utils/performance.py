...
async def check_performance_metrics(url: str,  client: httpx.AsyncClient) -> Union[Performance, ErrorResult]:
    ...
    try:
        ...
        if response.status_code == 200:
            try:
                ...
                return ErrorResult(error=f"Failed to parse performance data: {parse_error}")
        else:
